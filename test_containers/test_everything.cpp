...
/*   Updated: 2021/01/17 00:24:22 by lucaslefran      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	ft::vector<std::string> v31(6, "salut");
	std::string test("jbhkfbhsjdhfbhsdkjfbjksdbkhfsdf");
	v31[0] = test;
	
	ft::vector<std::string> tmp2 = v31;
	tmp2.assign(v31.begin(), v31.end());

	// ft::vector<Bob> v31(6);
	// Bob test;
	// v31[0] = test;
	
	// std::cout << "SALFLJKLJDFNJKASNFUT\n";
	// ft::vector<Bob> tmp2 = v31;
	// std::cout << "SALFLJKLJDFNJKASNFUT\n";
