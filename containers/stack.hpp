...
/*   Updated: 2021/02/03 10:15:05 by llefranc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	class stack
	{
		public:
			...
			*/
			...
			/**
			*	This is the destructor of the container object store as data that 
			...
			*	a new element at the top of the stack. Size is increased.
			*
